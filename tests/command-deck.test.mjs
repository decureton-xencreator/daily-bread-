...
for(const marker of['deck-progress','deck-count','deck-back','deck-index-button','deck-next','scene-index-list','assets/images/xen-globe.webp'])assert.match(html,new RegExp(marker));
