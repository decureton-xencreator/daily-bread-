...
export const defaults={name:'Commander',homeLocation:'Location not set',workLocation:'Not set',timezone:Intl.DateTimeFormat().resolvedOptions().timeZone,greeting:'direct',theme:'midnight',motion:'system',sports:'',news:'business, technology, world',markets:'energy, rates, materials',entertainment:'film, music, long-form',academyPriorities:'AI, Financial Intelligence, Spanish',travelMode:false,privacy:'local',hiddenModules:[],completed:[],saved:[],dismissed:[],notes:''};
